...
n<-as.integer(commandArgs(trailingOnly=TRUE)[1]);sample<-paste0('SCALE_',n)
dest<-file.path(base,'scalability',n,'SCINA');dir.create(dest,recursive=TRUE,showWarnings=FALSE)
