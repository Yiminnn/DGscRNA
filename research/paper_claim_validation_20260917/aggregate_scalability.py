...
def run():
    ...
    note+='\nJobs did not reserve nodes exclusively. Parallel jobs can share node resources, and background hardware load is uncontrolled. Reported wall times describe these observed SLURM conditions; they are not isolated-machine timing estimates.\n'
