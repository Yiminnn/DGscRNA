...
root <- Sys.getenv('DGSCRNA_SITE_ROOT',getwd())
base <- Sys.getenv('DGSCRNA_EXAMPLE_OUT');stopifnot(nzchar(base))
reference_lib <- Sys.getenv('DGSCRNA_REFERENCE_R_LIB','')
if(nzchar(reference_lib)).libPaths(c(reference_lib,.libPaths()))
