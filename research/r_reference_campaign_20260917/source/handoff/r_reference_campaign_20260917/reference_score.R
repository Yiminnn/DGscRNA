...
if (!nzchar(Sys.getenv('DGSCRNA_EXECUTION_SOURCE'))) {
  original_script <- '/fs/scratch/PCON0080/yimin/dgscrna/handoff/r_reference_campaign_20260917/reference_score.R'
  ...
  snapshot_script <- file.path(snapshot_dir, 'reference_score.R')
